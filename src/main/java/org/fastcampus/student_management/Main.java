...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    //기본 default 세팅 추가
    StudentInfoDto studentInfoDto = new StudentInfoDto("홍길동",20,"강남구");
    StudentInfoDto studentInfoDto2 = new StudentInfoDto("엄인국",20,"강남구");
    studentService.saveStudent(studentInfoDto);
    studentService.saveStudent(studentInfoDto2);

    CourseInfoDto courseInfoDto = new CourseInfoDto("수학",200000,"MONDAY","홍길동", 1717299008L);
    CourseInfoDto courseInfoDto2 = new CourseInfoDto("영어",200000,"THURSDAY","엄인국", 1717299008L);
